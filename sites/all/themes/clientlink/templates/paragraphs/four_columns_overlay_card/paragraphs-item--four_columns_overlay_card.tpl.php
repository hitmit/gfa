...
<div class="row four-col-card mt-5 pt-5 px-4 four-cols-overlay-card">
	<div class="col-sm-12">
		...
		<div class="row pt-5">
			<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 content"><?php echo $item1; ?></div>
			<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 content"><?php echo $item2; ?></div>
			<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 content"><?php echo $item3; ?></div>
			<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 content"><?php echo $item4; ?></div>	 
        </div>
